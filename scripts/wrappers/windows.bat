...
set PYPACK_URL=https://raw.githubusercontent.com/connor33341/pypack/refs/heads/main/default/.pypack
set CONFIG_URL=https://raw.githubusercontent.com/connor33341/pypack/refs/heads/main/default/.pypack-config
